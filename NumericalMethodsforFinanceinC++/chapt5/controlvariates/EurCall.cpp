...
// Efficient approximation of normal distribution probability (probability that values<=x)
double N(double x){
    double gamma = 0.2316419;
    double a1 = 0.319381530;
    double a2 = -0.35656782;
...
double EurCall::DeltaByBSFormula(double a, double b, double r, double S0){
    return N(d_plus(a, b, r))*a/S0;
}
